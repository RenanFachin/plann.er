        ...
        <div className="h-16 bg-zinc-900 px-4 flex items-center rounded-xl shadow-shape gap-3">
          ...
          <div className='flex items-center gap-2'>
            ...
            <input 
              type="text" 
              placeholder="Quando?" 
              className="bg-transparent text-lg placeholder:text-zinc-400 max-w-40 outline-none"
            />
          </div>

          <div className='w-px h-6 bg-zinc-800'/>

          <button className='bg-lime-300 text-lime-950 rounded-lg py-2 px-5 font-medium flex items-center gap-2 hover:bg-lime-400 transition-colors'>
            Continuar
